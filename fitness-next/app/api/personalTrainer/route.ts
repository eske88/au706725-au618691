...
export const fetchWorkoutProgram = async (token: string | null, programId:  string | string[] | undefined) => {
...
export async function POST(programId : any, token : any, exercise : any) {
