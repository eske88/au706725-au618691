import {JWTInfo, WorkoutProgram} from "@/app/Types";
...
export const fetchWorkoutProgram = async (token: string | null, programId: any) => {
...
export async function addExerciseToProgram(programId : any, token : any, exercise : any) {
